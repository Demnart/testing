        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <ul class="menu-category category-products">
                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            <?= Html::img("@web/images/products/{$product->img}",['alt'=>$product->img])?>
                            <h3>ZOOM</h3>
                        </div>
                            ...
                            <div class="product-information"><!--/product-information-->
                                ...
                                <img src="/images/product-details/rating.png" alt="" />
                                    <span>
								    	...
								    	<a href="<?= Url::to(['cart/add-cart','id'=>$product->id])?>" class="btn btn-fefault add-to-cart cart" data-id="<?= $product->id?>">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$<?= $hit->price?></h2>
                                                <a href="<?= Url::to(['product/view','id'=>$hit->img])?>"><p><?= $hit->name?></p></a>
